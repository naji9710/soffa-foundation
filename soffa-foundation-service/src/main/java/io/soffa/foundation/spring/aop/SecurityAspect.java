...
import io.soffa.foundation.core.exceptions.UnauthorizedException;
import io.soffa.foundation.core.exceptions.ValidationException;
...
public class SecurityAspect {
    ...
    @SneakyThrows
    @Before("@within(io.soffa.foundation.core.annotations.Authenticated) || @annotation(io.soffa.foundation.core.annotations.Authenticated)")
    ...
    @SneakyThrows
    @Before("@within(io.soffa.foundation.core.annotations.ApplicationRequired) || @annotation(io.soffa.foundation.core.annotations.ApplicationRequired)")
    ...
    @SneakyThrows
    @Before("@within(io.soffa.foundation.core.annotations.TenantRequired) || @annotation(io.soffa.foundation.core.annotations.TenantRequired)")
